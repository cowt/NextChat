...
const en: LocaleType = {
  ...
  Settings: {
    ...
    SummaryModel: {
      Title: "Summary Model",
      SubTitle:
        "Independent model for conversation titles and history compression",
    },
    Temperature: {
      Title: "Temperature",
  ...
  Store: {
    ...
    Prompt: {
      ...
      Topic:
        "Please generate a inner ten word title summarizing our conversation without any lead-in, punctuation, quotation marks, periods, symbols, bold text, or additional text. Remove enclosing quotation marks.",
      Summarize:
